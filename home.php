        ...
        <table class="grid-table" id="recGrid">
            ...
            <tbody id="auditRecTbody">
                ...
                if($selectedOffice === ''){
                    ...
                    $auditRecRendered = render_office_recommendation_rows($auditRecommendations, $selectedOffice, $selectedAudit);
...
(function(){
        ...
        if(deleteBtn){
            ...
            fetch('recommendations_api.php', {
                ...
                if(auditTbody.children.length === 0){
                    auditTbody.innerHTML = "<tr><td colspan='6' class='empty-state'>No recommendations available for this office</td></tr>";
                }
            });
        }
    });
    ...
    officeTabs.addEventListener('click', function(e){
        ...
        auditTbody.innerHTML = "<tr><td colspan='6' class='empty-state'>Loading&hellip;</td></tr>";
        ...
        fetch('office_recommendations_view.php?' + params.toString())
            ...
            .catch(function(){
                auditTbody.innerHTML = "<tr><td colspan='6' class='empty-state'>Unable to load recommendations right now.</td></tr>";
            });
    });
})();
</script>
